...
import { Target, Clock, Mic, DollarSign, RefreshCcw, Users, TrendingUp, Gauge } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'See who\'s delivering and who\'s blocked. Track task completion rates, delegation status, and team velocity — without micromanaging.',
    accent: '#f97316',
  },
  {
    icon: DollarSign,
    title: 'Cash Flow & Revenue',
    description: 'Revenue generated, money moved, burn rate, runway. Real-time financial pulse so you never get surprised by the bank balance.',
    accent: '#fbbf24',
  },
  {
    icon: Gauge,
    title: 'Operational Efficiency',
    description: 'Cycle time, throughput, cost-per-outcome. Identify bottlenecks before they become fires. Know exactly what your operations cost.',
    accent: '#14b8a6',
  },
  {
    icon: TrendingUp,
    title: 'Growth Metrics',
    description: 'MRR, pipeline value, conversion rates, customer acquisition cost. The numbers that matter for board meetings and decisions.',
    accent: '#e879f9',
  },
  {
    icon: Mic,
    title: 'Voice Commands',
    description: 'Just talk. Create tasks, log hours, complete items, and update priorities — all from natural language.',
    accent: '#f472b6',
  },
  {
    icon: RefreshCcw,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-6 transition-all duration-500 group relative overflow-hidden"
            >
              ...
              <div className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
